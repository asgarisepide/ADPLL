# ADPLL
A frequency detector (PFD) is used to compare the arrival times of the reference and divided clock edges from the DCO output frequency. The resulting early/late information is filtered through a DLF at a divided frequency.
